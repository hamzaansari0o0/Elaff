const FEATURES = [
  {
    ...
    content: (
      <>
        ...
        <a href="#" className="ml-1 text-brand-navy hover:text-brand-amber hover:underline transition-colors font-bold">
          Learn more
        </a>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <strong className="font-extrabold text-gray-800 uppercase tracking-widest">5000+ Reviews</strong>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <strong className="font-extrabold text-gray-800 uppercase tracking-widest">24/7 Phone</strong> and{' '}
        <strong className="font-extrabold text-gray-800 uppercase tracking-widest">Email Support</strong>
      </>
    ),
  },
];
    ...
    <section className="bg-slate-50 border-b border-gray-200 py-3 md:px-8">
      ...
      <div className="hidden md:flex max-w-7xl mx-auto justify-between items-center divide-x divide-gray-200 text-center">
        {FEATURES.map((feature, idx) => (
          <div
            key={idx}
            className="w-1/3 py-1 flex items-center justify-center gap-2.5 text-xs text-gray-600 font-bricolage tracking-wide"
          >
            {feature.icon}
