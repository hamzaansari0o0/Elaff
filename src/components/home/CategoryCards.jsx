...
export default async function CategoryCards() {
  const CATEGORY_CARDS = await getCategoryCards();
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        {CATEGORY_CARDS.map((cat, idx) => (
          ...
          >
            ...
            <h3 className="font-fraunces text-[11px] md:text-xs font-extrabold text-gray-800 uppercase tracking-wider mb-1 group-hover:text-brand-navy transition-colors">
              {cat.title}
            </h3>
